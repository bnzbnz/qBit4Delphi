...
function URLEncodeVarList(Str: string; Delimiter: Char): string;
begin
...
begin
  ...
  var Body := Format(
                ...
                [ BoolToStr[Normal],  BoolToStr[Info],  BoolToStr[Warning],  BoolToStr[Critical], LastKnownId ]
              );
...
begin
  FDuration := GetTickCount;
  var Body := Format('peers=%s', [URLEncodeVarList(PeerListStr, '|')]);
...
begin
  ...
  if Indexes = '' then
    ...
    Body := Format('hash=%s&indexes=%s', [Hash, URLEncodeVarList(Indexes, '|')]);
...
begin
  FDuration := GetTickCount;
  var Body := Format('hashes=%s&deleteFiles=%s', [Hashes, BoolToStr[DeleteFiles]]);
...
begin
  FDuration := GetTickCount;
  var Body := Format('hash=%s&urls=%s', [Hash, URLEncodeVarList(Urls, #$A)]);
...
begin
  FDuration := GetTickCount;
  var Body := Format('hash=%s&urls=%s', [Hash, URLEncodeVarList(Urls, '|')]);
...
begin
  FDuration := GetTickCount;
  var Body := Format('hashes=%s&peers=%s', [Hashes, URLEncodeVarList(Peers, '|')]);
...
begin
  FDuration := GetTickCount;
  var Body := Format('hash=%s&id=%s&priority=%d', [Hash,  URLEncodeVarList(Ids, '|'), Priority]);
...
begin
  FDuration := GetTickCount;
  var Body := Format('categories=%s', [URLEncodeVarList(Categories, #$A)]);
...
begin
  FDuration := GetTickCount;
  var Body := Format('hashes=%s&tags=%s', [Hashes, URLEncodeVarList(Tags, '|')]);
...
begin
  FDuration := GetTickCount;
  var Body := Format('tags=%s', [URLEncodeVarList(Tags, ',')]);
...
begin
  FDuration := GetTickCount;
  var Body := Format('hashes=%s&enable=%s', [Hashes, BoolToStr[Enable]]);
...
begin
  FDuration := GetTickCount;
  var Body := Format('hashes=%s&value=%s', [Hashes, BoolToStr[Value]]);
...
begin
  ...
  try
    ...
    SS.WriteString('');
    SS.WriteString(#$D#$A);
    SS.WriteString(BoolToStr[NewTorrentUrls.FautoTMM]);
    SS.WriteString(#$D#$A);
    SS.WriteString('--' + Boundary);
    SS.WriteString(#$D#$A);
    ...
    SS.WriteString('');
    SS.WriteString(#$D#$A);
    SS.WriteString(BoolToStr[NewTorrentUrls.Fpaused]);
    SS.WriteString(#$D#$A);
    SS.WriteString('--' + Boundary);
    SS.WriteString(#$D#$A);
    ...
    SS.WriteString('');
    SS.WriteString(#$D#$A);
    SS.WriteString(BoolToStr[NewTorrentUrls.Fskip_Checking]);
    SS.WriteString(#$D#$A);
    SS.WriteString('--' + Boundary);
    SS.WriteString(#$D#$A);
    ...
    SS.WriteString('');
    SS.WriteString(#$D#$A);
    SS.WriteString(BoolToStr[NewTorrentUrls.FsequentialDownload]);
    SS.WriteString(#$D#$A);
    SS.WriteString('--' + Boundary);
    SS.WriteString(#$D#$A);
    ...
    SS.WriteString('');
    SS.WriteString(#$D#$A);
    SS.WriteString(BoolToStr[NewTorrentUrls.FfirstLastPiecePrio]);
    SS.WriteString(#$D#$A);
    SS.WriteString('--' + Boundary);
    SS.WriteString(#$D#$A);
...
begin
  ...
  try
    ...
    SS.WriteString('');
    SS.WriteString(#$D#$A);
    SS.WriteString(BoolToStr[NewTorrentFile.FautoTMM]);
    SS.WriteString(#$D#$A);
    SS.WriteString('--' + Boundary);
    SS.WriteString(#$D#$A);
    SS.WriteString('Content-Disposition: form-data; name="savepath"');
    ...
    SS.WriteString('');
    SS.WriteString(#$D#$A);
    SS.WriteString(BoolToStr[NewTorrentFile.Fpaused]);
    SS.WriteString(#$D#$A);
    SS.WriteString('--' + Boundary);
    SS.WriteString(#$D#$A);
    SS.WriteString('Content-Disposition: form-data; name="skip_checking"');
    ...
    SS.WriteString('');
    SS.WriteString(#$D#$A);
    SS.WriteString(BoolToStr[NewTorrentFile.Fskip_Checking]);
    SS.WriteString(#$D#$A);
    SS.WriteString('--' + Boundary);
    SS.WriteString(#$D#$A);
    SS.WriteString('Content-Disposition: form-data; name="contentLayout"');
    ...
    SS.WriteString('');
    SS.WriteString(#$D#$A);
    SS.WriteString(BoolToStr[NewTorrentFile.FsequentialDownload]);
    SS.WriteString(#$D#$A);
    SS.WriteString('--' + Boundary);
    SS.WriteString(#$D#$A);
    SS.WriteString('Content-Disposition: form-data; name="firstLastPiecePrio"');
    ...
    SS.WriteString('');
    SS.WriteString(#$D#$A);
    SS.WriteString(BoolToStr[NewTorrentFile.FfirstLastPiecePrio]);
    SS.WriteString(#$D#$A);
    SS.WriteString('--' + Boundary);
    SS.WriteString(#$D#$A);
    SS.WriteString('Content-Disposition: form-data; name="dlLimit"');
...
begin
  FDuration := GetTickCount;
  Result := nil;
  var Body :=   Format('withData=%s', [URLEncode(BoolToStr[WithData])]);
